     ...
     <div className="w-full h-full pt-5 pb-5 bg-black">
       <div className="w-full h-80 flex justify-center items-center">
        ...
        <div>
           ...
           <textarea name="douts" id="" cols="150" rows="10" className='border-2 border-violet-700 resize-none rounded-md focus:outline-none focus:border-violet-900 p-4'></textarea>
